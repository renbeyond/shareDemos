...
/**
 * Created by bauer_bao on 16/3/7.
 */
public class MaterialDesignMainActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bauer_activity_material_design_main);
        //初始化控件及布局
        initView();
    }
    ...
    private void initView() {
        ...
        //设置logo
        actionBar.setHomeAsUpIndicator(R.drawable.bauer_pa_logo);
        //true则显示logo
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        //主界面右上角的menu菜单
        getMenuInflater().inflate(R.menu.bauer_md_main, menu);
        return true;
    }
